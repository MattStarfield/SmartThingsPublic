...
metadata {
	definition (name: "Andluca Z3SwitchSoc DTH", namespace: "mattstarfield", author: "Matt Starfield", ocfDeviceType: "oic.d.switch", runLocally: true, minHubCoreVersion: '000.019.00012', executeCommandsLocally: true, genericHandler: "Zigbee") {
		capability "Actuator"
		...
		// Andluca
        fingerprint profileId: "0104", inClusters: "0000, 0003, 0004, 0005, 0006", deviceJoinName: "Andluca Switch" //Z3SwitchSoc demo
/*        
        // Generic
